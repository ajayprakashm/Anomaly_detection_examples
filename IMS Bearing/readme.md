...
This dataset is of second gear failure test, data is downloaded and merged into one file, so merged file consists of four bearing data. All four bearing are tested to run to failure.
